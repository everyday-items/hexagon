...
| VectorStore | MemoryStore, QdrantStore |
...
**ai-core** (`github.com/everyday-items/ai-core`):
- LLM Provider 接口和实现 (OpenAI, DeepSeek, Anthropic, Gemini, Qwen, Ark, Ollama)
- Tool 工具系统
- Memory 记忆系统
- Schema JSON Schema 生成

**toolkit** (`github.com/everyday-items/toolkit`):
- 类型转换、字符串工具
- HTTP 客户端、SSE 支持
- 缓存、重试、限流
- ID 生成、协程池
